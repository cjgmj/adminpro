...
// Actualizar usuario
// ===============================
app.put('/:id', [mdAutenticacion.verifyToken, mdAutenticacion.verifyAdminOrMe], (req, res) => {
...
// Borrar usuario
// ===============================
app.delete('/:id', [mdAutenticacion.verifyToken, mdAutenticacion.verifyAdminOrMe], (req, res) => {
    var id = req.params.id;
